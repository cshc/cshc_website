...
class ClubViewTest(TestCase):
    ...
    def test_ClubListView(self):
        ...
        retrieved_club = response.context['club_list'].get(pk=self.test_club.pk)
...
class TeamViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.test_team, team_created = Team.objects.get_or_create(club=self.test_club, gender=TeamGender.mens, ordinal=TeamOrdinal.T1)
    ...
    def test_TeamListView(self):
        ...
        self.assertEquals(self.test_team.ordinal, retrieved_team.ordinal)
