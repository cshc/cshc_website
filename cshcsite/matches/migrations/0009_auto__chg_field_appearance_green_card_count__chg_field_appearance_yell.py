...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Appearance.green_card_count'
        db.alter_column(u'matches_appearance', 'green_card_count', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'Appearance.yellow_card_count'
        db.alter_column(u'matches_appearance', 'yellow_card_count', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Appearance.green_card_count'
        db.alter_column(u'matches_appearance', 'green_card_count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Appearance.yellow_card_count'
        db.alter_column(u'matches_appearance', 'yellow_card_count', self.gf('django.db.models.fields.IntegerField')(null=True))
