...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoalKing.l3_goals'
        db.add_column(u'matches_goalking', 'l3_goals',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GoalKing.l3_own_goals'
        db.add_column(u'matches_goalking', 'l3_own_goals',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GoalKing.l3_goals'
        db.delete_column(u'matches_goalking', 'l3_goals')

        # Deleting field 'GoalKing.l3_own_goals'
        db.delete_column(u'matches_goalking', 'l3_own_goals')
