...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GoalKing.vets_own_goals'
        db.delete_column(u'matches_goalking', 'vets_own_goals')

        # Deleting field 'GoalKing.vets_goals'
        db.delete_column(u'matches_goalking', 'vets_goals')

        # Adding field 'GoalKing.mv_goals'
        db.add_column(u'matches_goalking', 'mv_goals',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GoalKing.mv_own_goals'
        db.add_column(u'matches_goalking', 'mv_own_goals',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GoalKing.vets_own_goals'
        db.add_column(u'matches_goalking', 'vets_own_goals',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GoalKing.vets_goals'
        db.add_column(u'matches_goalking', 'vets_goals',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'GoalKing.mv_goals'
        db.delete_column(u'matches_goalking', 'mv_goals')

        # Deleting field 'GoalKing.mv_own_goals'
        db.delete_column(u'matches_goalking', 'mv_own_goals')
    ...
    models = {
        ...
        'matches.appearance': {
            ...
            'green_card_count': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'red_card': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'yellow_card_count': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'})
        },
        'matches.goalking': {
            ...
            'mv_goals': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'mv_own_goals': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
