...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Appearance.yellow_card'
        db.delete_column(u'matches_appearance', 'yellow_card')

        # Deleting field 'Appearance.green_card'
        db.delete_column(u'matches_appearance', 'green_card')


    def backwards(self, orm):
        # Adding field 'Appearance.yellow_card'
        db.add_column(u'matches_appearance', 'yellow_card',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Appearance.green_card'
        db.add_column(u'matches_appearance', 'green_card',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
                      keep_default=False)
