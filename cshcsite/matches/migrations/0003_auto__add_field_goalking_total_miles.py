...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoalKing.total_miles'
        db.add_column(u'matches_goalking', 'total_miles',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GoalKing.total_miles'
        db.delete_column(u'matches_goalking', 'total_miles')
