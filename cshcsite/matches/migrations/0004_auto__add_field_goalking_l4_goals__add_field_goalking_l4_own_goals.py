...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoalKing.l4_goals'
        db.add_column(u'matches_goalking', 'l4_goals',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GoalKing.l4_own_goals'
        db.add_column(u'matches_goalking', 'l4_own_goals',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GoalKing.l4_goals'
        db.delete_column(u'matches_goalking', 'l4_goals')

        # Deleting field 'GoalKing.l4_own_goals'
        db.delete_column(u'matches_goalking', 'l4_own_goals')
