...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoalKing.l5_goals'
        db.add_column(u'matches_goalking', 'l5_goals',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GoalKing.l5_own_goals'
        db.add_column(u'matches_goalking', 'l5_own_goals',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GoalKing.l5_goals'
        db.delete_column(u'matches_goalking', 'l5_goals')

        # Deleting field 'GoalKing.l5_own_goals'
        db.delete_column(u'matches_goalking', 'l5_own_goals')
