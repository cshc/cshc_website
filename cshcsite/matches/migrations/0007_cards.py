...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for app in orm.Appearance.objects.all():
    ...
    models = {
        ...
        'matches.appearance': {
            ...
            'green_card_count': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'yellow_card_count': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'})
        },
        'matches.goalking': {
