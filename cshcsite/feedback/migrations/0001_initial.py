...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'feedback_feedback', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.CshcUser'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('page', self.gf('django.db.models.fields.CharField')(max_length='255', blank=True)),
    ...
    models = {
        ...
        u'feedback.feedback': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.CshcUser']"})
        }
    }
