...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MatchAward'
        db.create_table(u'awards_matchaward', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('awards', ['MatchAward'])

        # Adding model 'EndOfSeasonAward'
        db.create_table(u'awards_endofseasonaward', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('awards', ['EndOfSeasonAward'])

        # Adding model 'MatchAwardWinner'
        db.create_table(u'awards_matchawardwinner', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='awards_matchawardwinner_awards', null=True, blank=True, to=orm['members.Member'])),
            ('awardee', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('comment', self.gf('django.db.models.fields.TextField')()),
            ('match', self.gf('django.db.models.fields.related.ForeignKey')(related_name='award_winners', to=orm['matches.Match'])),
            ('award', self.gf('django.db.models.fields.related.ForeignKey')(related_name='winners', to=orm['awards.MatchAward'])),
        ))
        db.send_create_signal('awards', ['MatchAwardWinner'])

        # Adding model 'EndOfSeasonAwardWinner'
        db.create_table(u'awards_endofseasonawardwinner', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='awards_endofseasonawardwinner_awards', null=True, blank=True, to=orm['members.Member'])),
            ('awardee', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('comment', self.gf('django.db.models.fields.TextField')()),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(related_name='award_winners', to=orm['competitions.Season'])),
            ('award', self.gf('django.db.models.fields.related.ForeignKey')(related_name='winners', to=orm['awards.EndOfSeasonAward'])),
        ))
        db.send_create_signal('awards', ['EndOfSeasonAwardWinner'])


    def backwards(self, orm):
        # Deleting model 'MatchAward'
        db.delete_table(u'awards_matchaward')

        # Deleting model 'EndOfSeasonAward'
        db.delete_table(u'awards_endofseasonaward')

        # Deleting model 'MatchAwardWinner'
        db.delete_table(u'awards_matchawardwinner')

        # Deleting model 'EndOfSeasonAwardWinner'
        db.delete_table(u'awards_endofseasonawardwinner')
    ...
    models = {
        ...
        'awards.endofseasonaward': {
            'Meta': {'ordering': "['name']", 'object_name': 'EndOfSeasonAward'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'})
        },
        'awards.endofseasonawardwinner': {
            'Meta': {'object_name': 'EndOfSeasonAwardWinner'},
            'award': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'winners'", 'to': "orm['awards.EndOfSeasonAward']"}),
            'awardee': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'comment': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'awards_endofseasonawardwinner_awards'", 'null': 'True', 'blank': 'True', 'to': "orm['members.Member']"}),
            'season': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'award_winners'", 'to': "orm['competitions.Season']"})
        },
        'awards.matchaward': {
            'Meta': {'ordering': "['name']", 'object_name': 'MatchAward'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'})
        },
        'awards.matchawardwinner': {
            'Meta': {'object_name': 'MatchAwardWinner'},
            'award': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'winners'", 'to': "orm['awards.MatchAward']"}),
            'awardee': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'comment': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'match': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'award_winners'", 'to': "orm['matches.Match']"}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'awards_matchawardwinner_awards'", 'null': 'True', 'blank': 'True', 'to': "orm['members.Member']"})
        },
        'competitions.cup': {
