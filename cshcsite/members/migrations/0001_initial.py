...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'members_member', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.CshcUser'], unique=True, null=True, on_delete=models.SET_NULL, blank=True)),
            ...
            ('pref_position', self.gf('django.db.models.fields.IntegerField')(default=9)),
            ('is_current', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('shirt_number', self.gf('django.db.models.fields.CharField')(max_length=4, blank=True)),
        ))
        db.send_create_signal('members', ['Member'])

        # Adding model 'SquadMembership'
        db.create_table(u'members_squadmembership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('members', ['SquadMembership'])

        # Adding unique constraint on 'SquadMembership', fields ['member', 'team', 'season']
        db.create_unique(u'members_squadmembership', ['member_id', 'team_id', 'season_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SquadMembership', fields ['member', 'team', 'season']
        db.delete_unique(u'members_squadmembership', ['member_id', 'team_id', 'season_id'])

        # Deleting model 'Member'
        db.delete_table(u'members_member')

        # Deleting model 'SquadMembership'
        db.delete_table(u'members_squadmembership')
