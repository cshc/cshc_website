...
class VenueTest(TestCase):
    ...
    def test_both_venue_name_and_short_name_must_be_supplied(self):
        ...
        self.assertRaisesMessage(IntegrityError, "venues_venue.name may not be NULL", venue_with_no_name.save)
        ...
        self.assertRaisesMessage(IntegrityError, "venues_venue.short_name may not be NULL", venue_with_no_short_name.save)
