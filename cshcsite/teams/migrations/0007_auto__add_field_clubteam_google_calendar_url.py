...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClubTeam.google_calendar_url'
        db.add_column(u'teams_clubteam', 'google_calendar_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClubTeam.google_calendar_url'
        db.delete_column(u'teams_clubteam', 'google_calendar_url')
