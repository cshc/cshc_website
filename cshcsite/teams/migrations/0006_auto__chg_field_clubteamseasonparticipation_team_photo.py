...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClubTeamSeasonParticipation.team_photo'
        db.alter_column(u'teams_clubteamseasonparticipation', 'team_photo', self.gf(u'django_resized.forms.ResizedImageField')(max_length=100, null=True, max_width=900, max_height=600))

    def backwards(self, orm):

        # Changing field 'ClubTeamSeasonParticipation.team_photo'
        db.alter_column(u'teams_clubteamseasonparticipation', 'team_photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        'teams.clubteamseasonparticipation': {
            ...
            'team_photo': (u'django_resized.forms.ResizedImageField', [], {'max_length': '100', 'null': 'True', 'max_width': '900', 'max_height': '600', 'blank': 'True'}),
