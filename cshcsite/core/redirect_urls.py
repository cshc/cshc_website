...
urlpatterns = patterns('',
    ...
    url(r'about/pitch-directions.php^$', RedirectView.as_view(url=reverse_lazy('pitch_directions'))),
    ...
    url(r'about/chairmans-notes.php^$', RedirectView.as_view(url=reverse_lazy('chairmans_notes'))),
    ...
    url(r'reports.php^$', RedirectView.as_view(url=reverse_lazy('matches_by_season'))),
    url(r'reports/(.*).php^$', RedirectView.as_view(url=reverse_lazy('matches_by_season'))),
