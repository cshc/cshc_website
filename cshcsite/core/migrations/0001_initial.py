...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClubInfo'
        db.create_table(u'core_clubinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'core', ['ClubInfo'])

        # Adding model 'ContactSubmission'
        db.create_table(u'core_contactsubmission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('core', ['ContactSubmission'])

        # Adding model 'CshcUser'
        db.create_table(u'core_cshcuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
    ...
    def backwards(self, orm):
        # Deleting model 'ClubInfo'
        db.delete_table(u'core_clubinfo')

        # Deleting model 'ContactSubmission'
        db.delete_table(u'core_contactsubmission')

        # Deleting model 'CshcUser'
