...
from club.models import Cup, League
...
class CupTest(TestCase):
    ...
    def test_cups_can_be_added_and_removed(self):
        ...
        cup1.save()
        cup2.save()
        self.assertEqual(2, Cup.objects.all().count())
        cup1.delete()
        cup2.delete()
        self.assertEqual(0, Cup.objects.all().count())
    ...
    def test_cup_league_is_optional(self):
        ...
        self.assertEqual(1, Cup.objects.all().count())
