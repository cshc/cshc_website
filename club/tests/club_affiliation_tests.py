...
class ClubAffiliationTest(TestCase):
    ...
    def setUp(self):
        self.user1=User(first_name="Graham", last_name="McCulloch", email="test@test.com", username="gm")
    ...
    def test_club_affiliations_can_be_added_and_removed(self):
        ...
        countBefore = ClubAffiliation.objects.all().count()
        ...
        ca1.save()
        ca2.save()
        self.assertEqual(countBefore + 2, ClubAffiliation.objects.all().count())
        ca1.delete()
        ca2.delete()
        self.assertEqual(countBefore, ClubAffiliation.objects.all().count())
    ...
    def test_club_affiliation_end_is_optional(self):
        ...
        ca1.save()
        self.assertEqual(countBefore + 1, ClubAffiliation.objects.all().count())
