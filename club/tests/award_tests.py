...
class EndofSeasonAwardTest(TestCase):
    ...
    def test_end_of_season_awards_can_be_added_and_removed(self):
        ...
        award1 = EndOfSeasonAward(name="1st team: Player of the season")
...
class MatchAwardWinnerTest(AwardWinnerTest):
    ...
    def test_match_award_winners_can_be_added_and_removed(self):
        ...
        awardWinner1 = MatchAwardWinner(match=self.test_match, award=self.test_match_award1, player=self.test_player1, comment="A note")
    ...
    def test_awardee_or_player_must_be_specified(self):
        """Test that you must specify either the player or the awardee for an award winner"""
...
class EndOfSeasonAwardWinnerTest(AwardWinnerTest):
    ...
    def setUp(self):
        ...
        self.test_award1 = EndOfSeasonAward(name="1st team: Player of the season")
    ...
    def test_end_of_season_award_winners_can_be_added_and_removed(self):
        ...
        awardWinner1 = EndOfSeasonAwardWinner(season=self.test_season, award=self.test_award1, player=self.test_player1, comment="A note")
